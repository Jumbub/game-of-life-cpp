...
test_github:
	g++ src/test/main.cpp src/logic/board.cpp src/logic/next.cpp src/logic/padding.cpp src/common/lock.cpp src/common/setBenchmarkBoard.cpp -Wall -Wextra -Werror -Wpedantic -Wsign-conversion -std=c++2a -lpthread -O3 -o test
	./test
